...
<body class="bg-gray-50 min-h-screen">
    <?php if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true): ?>
        ...
        <nav class="bg-white shadow-md lg:hidden">
            <div class="px-4 py-3 flex items-center justify-between">
                <a href="/admin/dashboard" class="text-xl font-heading font-semibold text-primary hover:opacity-80 transition-opacity">Pequenos a Bordo</a>
            ...
            <div id="mobileMenu" class="hidden px-4 pb-4">
                ...
                <a href="/admin/logistica" class="block py-2 text-gray-700 hover:text-primary">Logística</a>
        ...
        <nav class="hidden lg:block bg-white shadow-md">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between py-4">
                    <a href="/admin/dashboard" class="text-2xl font-heading font-semibold text-primary hover:opacity-80 transition-opacity">Pequenos a Bordo</a>
                    <div class="flex space-x-6">
                        ...
                        <a href="/admin/logistica" class="text-gray-700 hover:text-primary font-medium">Logística</a>
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4 mx-4 lg:mx-auto lg:max-w-6xl mt-4"
            role="alert">
    ...
    <?php if (isset($_GET['error'])): ?>
        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4 mx-4 lg:mx-auto lg:max-w-6xl mt-4"
            role="alert">
