...
| Banco incompleto / tabelas não existem | No Coolify o bind mount de `db/init` não funciona — o dump vai **dentro da imagem** `db`. Apague o volume `mysql_data` e redeploy |
