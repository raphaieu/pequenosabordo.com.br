<template>
  <section id="sobre" class="padding-large">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <h3 class="text-3xl md:text-4xl lg:text-5xl font-heading font-normal text-center mb-8 lg:mb-12">
        Quem Somos?
      </h3>
